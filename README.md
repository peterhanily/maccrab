...
[![Tests](https://img.shields.io/badge/tests-1589%20passing-brightgreen)]()
[![Rules](https://img.shields.io/badge/rules-436%20%2B%2039%20seq%20%2B%206%20graph-blueviolet)]()
[![Version](https://img.shields.io/badge/version-1.12.6-blue)](https://github.com/peterhanily/maccrab/releases)
...
|---|---|---:|
| `TA0001` | Initial Access | 59 |
| `TA0002` | Execution | 87 |
| `TA0003` | Persistence | 84 |
| `TA0004` | Privilege Escalation | 43 |
| `TA0005` | Defense Evasion | 101 |
| `TA0006` | Credential Access | 76 |
| `TA0007` | Discovery | 33 |
| `TA0008` | Lateral Movement | 23 |
| `TA0009` | Collection | 37 |
