...
[![Version](https://img.shields.io/badge/version-1.18.1-blue)](https://github.com/peterhanily/maccrab/releases)
...
- **False-positive regression harness** -- every real FP observed in a live install now has a one-line `@Test`. **2165 tests in 403 suites**, FP regressions blocked at CI.
