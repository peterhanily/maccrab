...
[![Version](https://img.shields.io/badge/version-1.6.0-blue)](https://github.com/peterhanily/maccrab/releases)
...
- **False-positive regression harness** -- every real FP observed in a live install now has a one-line `@Test`. **636 tests in 136 suites**, FP regressions blocked at CI.
