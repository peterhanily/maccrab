...
def main():
    ...
    print(f"  (will be removed; do not enable). Promotion from")
    print(f"  `experimental` to `stable` follows the quantitative bar in")
    print(f"  [`CONTRIBUTING.md`](../CONTRIBUTING.md) (\"Rule Promotion")
    print(f"  Criteria\") — checkable with `scripts/check-promotion.sh")
    print(f"  <rule-id>`.")
