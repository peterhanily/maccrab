...
// These decouple the UI from the HawkEyeCore domain types and provide
...
/// Mirrors `HawkEyeCore.Severity` so the app target can be built independently
...
/// Mirrors `HawkEyeCore.EventCategory` for the UI layer.
