...
// HawkEyeCore
//
// Process lineage baseline anomaly detection engine for HawkEye (Layer 3).
...
public actor BaselineEngine {
    ...
    private let logger = Logger(subsystem: "com.hawkeye.detection", category: "BaselineEngine")
    ...
    public init(config: Config? = nil) {
        ...
        // Build persistence path: ~/Library/Application Support/HawkEye/baseline.json
