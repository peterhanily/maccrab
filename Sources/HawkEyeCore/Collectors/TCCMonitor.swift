...
public actor TCCMonitor {
    ...
    private let logger = Logger(subsystem: "com.hawkeye.core", category: "TCCMonitor")
    ...
    private func installWatcher(path: String, label: String) {
        ...
        let source = DispatchSource.makeFileSystemObjectSource(
            ...
            queue: DispatchQueue(label: "com.hawkeye.tccmonitor.\(label)")
        )
    ...
    /// Builds a HawkEye `Event` from a TCC entry.
