...
public enum ScannerDisplay {
    ...
    private static let contentTypeNames: [String: String] = [
        "remote_hands.finding": "Remote Hands findings",
        "remote_hands.summary": "Remote Hands scope",
        "skill_check.finding": "Skill Check findings",
        "skill_check.summary": "Skill Check scope",
        "localhost_lens.finding": "Localhost Lens findings",
        "localhost_lens.summary": "Localhost Lens scope",
        "dependency_autopsy.finding": "Dependency Autopsy findings",
        "dependency_autopsy.summary": "Dependency Autopsy scope",
        "decoy.finding": "Decoy findings",
        "decoy.summary": "Decoy scope",
        "exit_check.finding": "Exit Check findings",
        "exit_check.summary": "Exit Check scope",
        "side_door.finding": "Side Door findings",
        "side_door.summary": "Side Door scope",
        "identity_aftershock.finding": "Identity Aftershock findings",
        "identity_aftershock.summary": "Identity Aftershock scope",
        "build_witness.finding": "Build Witness findings",
        "build_witness.summary": "Build Witness scope",
        "last_good.finding": "Last Good findings",
        "last_good.summary": "Last Good scope",
        "trust_delta.review": "App update review",
        "first_hour.review": "Investigation review",
        "rave.review.saved": "Saved reviews and decisions",
        "rave.review.error": "Review could not complete",
        "script_trace.summary": "Selected script sources",
        "repo_tripwire.summary": "Selected project sources",
        "repo_tripwire.finding": "Project execution review",
        "script_trace.finding": "Script behavior review",
        "secret_trail.credential": "Credential copies",
        "secret_trail.summary": "Secret Trail summary",
        "secret_trail.occurrence": "Occurrences",
        "secret_trail.gap": "Coverage gaps",
        "secret_trail.setup": "Source selection needed",
        // TCC
