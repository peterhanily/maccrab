...
public enum BuiltinRuleCatalog {
    public static let all: [BuiltinRuleDefinition] = [
        ...
        .init("maccrab.ai-guard.file-injection", "AI Tool Accessed Possible Hidden Text",
              "A file an AI tool accessed contains suspicious Unicode structure; this does not confirm prompt injection.",
              .medium, "AI Guard"),
        ...
        .init("maccrab.sdr_device", "SDR Device / Display Hotplug",
              "A known SDR USB device was connected, or an anomalous display hotplug pattern was seen. Equipment/behavior detection — not confirmation of electromagnetic eavesdropping.",
              .high, "SDR"),
        ...
        .init("maccrab.llm", "LLM Analysis",
              "Advisory campaign investigation summaries and defense recommendations produced by the configured LLM.",
              .informational, "LLM Analysis"),
        .init("maccrab.counterfactual", "Counterfactual Analysis",
              "Deterministic analysis of the earliest prevention primitive that could have interrupted a detected sequence.",
              .informational, "Advisory Analysis"),
        .init("maccrab.predict.next-technique", "Predicted Next Technique",
              "Deterministic Markov prior over likely next ATT&CK tactics in an unfolding sequence.",
              .informational, "Advisory Analysis"),
