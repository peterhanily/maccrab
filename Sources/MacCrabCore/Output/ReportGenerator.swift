...
public actor ReportGenerator {
    ...
    public struct ReportData: Sendable {
        ...
        /// LLM-generated narrative summary (nil when no LLM is configured).
    ...
    public func generateHTML(from data: ReportData) -> String {
        ...
        if let narrative = data.narrativeSummary {
            html += """
            <section class="card">
                <h2>AI Analysis</h2>
                ...
                <p style="font-size: 11px; color: #999; margin-top: 12px;">Generated by LLM backend. Advisory only.</p>
            </section>
            """
        }
