...
```bash
swift test                     # Unit tests (4418 tests in 684 suites)
...
Tests/            Swift Testing unit tests (4418 tests in 684 suites)
```
...
- events family = `eventsMaxSizeMB - evidenceMaxSizeMB` = `440 - 100` = **340 MB** (`effectiveEventsFamilyMaxSizeMB`, floored at `minimumEventsSizeMiB`)
