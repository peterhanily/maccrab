...
| Rule | Status | Severity | MITRE Techniques |
|---|---|---|---|
| `airdrop_file_staging.yml`<br/>Credential Or Keystore File Staged In AirDrop Directory | experimental | high | T1011 T1552 |
...
| `keylogger_event_tap.yml`<br/>CGEventTap API Reference In Command Line By Non-Apple Process | experimental | high | T1056.001 |
...
| `usb_mass_storage_connected.yml`<br/>Disk Image Or Volume Mount From Non-System Process | experimental | low | T1200 T1204.002 |
...
| `python_socket_server.yml`<br/>Python Socket Server or HTTP Server Bound to All Interfaces | experimental | medium | T1071.001 |
...
| `token_revocation_polling_loop.yml`<br/>Periodic api.github.com /user Poll From Non-TTY Lineage (Dead-Man's-Switch Watchdog) | experimental | high | T1071.001 T1102 |
...
| `binary_resigned_post_installation.yml`<br/>codesign Re-Sign of Installed Application Bundle | experimental | high | T1036.001 T1554 |
| `bulk_quarantine_strip.yml`<br/>Bulk Quarantine-Attribute Strip Across Many Files | experimental | high | T1553.001 T1564.001 |
...
| `env_var_injection.yml`<br/>Interpreter Search-Path Env Var Set on Non-Platform Process | experimental | medium | T1574.007 |
...
| `locale_check_from_package_lineage.yml`<br/>AppleLanguages / Locale Probe From Package-Manager Lineage (Geofence Skip) | experimental | medium | T1195.001 T1480 T1614.001 |
...
| `vm_detection_probe_from_package_lineage.yml`<br/>VM / Sandbox Detection Probe From Package-Manager Lineage | experimental | high | T1082 T1195.001 T1497.001 |
| `wifi_attack_tool.yml`<br/>Wi-Fi Attack or Reconnaissance Tool Detected | experimental | high | T1557 |
| `wifi_ssid_change.yml`<br/>Wi-Fi Network SSID Changed or Evil Twin Indicator | experimental | medium | T1204 T1204.001 T1557 |
...
| `nscript_suspicious.yml`<br/>osascript Loading Script from Mounted Volume or Network URL | experimental | high | T1059.002 |
...
| `swift_repl_suspicious.yml`<br/>Swift Inline Evaluation From Non-Developer, Non-Terminal Parent | experimental | medium | T1059 |
...
| Rule | Status | Severity | MITRE Techniques |
|---|---|---|---|
| `airplay_to_non_apple_device.yml`<br/>Third-Party AirPlay Receiver or Sender Binary Executed | experimental | medium | T1125 |
...
| `mass_ssh_from_single_process.yml`<br/>Suspicious SSH from Script-like or Non-Interactive Parent | experimental | medium | T1021.004 T1570 |
...
| `maintainer_publish_hour_anomaly.yml`<br/>Package Publish From Non-Interactive Parent (Drift-Detection Input) | experimental | medium | T1078 |
...
| `bun_executes_from_node_modules.yml`<br/>Bun Runtime Executes From node_modules (Mini Shai-Hulud Evasion) | experimental | high | T1027 T1059 T1195.001 |
...
| `node_ipc_compromised_versions.yml`<br/>Compromised node-ipc Version Observed in node_modules (peacenotwar 9.1.6/9.2.3/12.0.1) | experimental | critical | T1059.007 T1195.001 T1485 |
| `node_modules_contains_leaked_dotfile.yml`<br/>Leaked Dotfile / Secret Material Under node_modules After Install | experimental | high | T1195.001 T1552.001 |
...
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1053.003 | T1055 | T1056 | T1056.001 | T1056.002 | T1057 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1059 | T1059.002 | T1059.004 | T1059.006 | T1059.007 | T1068 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1069 | T1069.001 | T1069.002 | T1070.002 | T1070.003 | T1070.004 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1070.006 | T1071 | T1071.001 | T1071.004 | T1078 | T1078.004 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
...
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1140 | T1176 | T1185 | T1189 | T1190 | T1195 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1195.001 | T1195.002 | T1200 | T1201 | T1204 | T1204.001 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1204.002 | T1217 | T1219 | T1480 | T1485 | T1486 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1489 | T1490 | T1496 | T1497 | T1497.001 | T1498 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1505.003 | T1518 | T1518.001 | T1528 | T1529 | T1539 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1542.001 | T1542.003 | T1543 | T1543.001 | T1543.004 | T1546 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1546.004 | T1546.016 | T1547 | T1547.002 | T1547.006 | T1547.011 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1547.015 | T1548 | T1548.001 | T1548.003 | T1548.004 | T1552 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1552.001 | T1552.004 | T1552.005 | T1552.007 | T1553.001 | T1553.002 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1553.004 | T1553.006 | T1554 | T1555 | T1555.001 | T1555.003 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
...
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1564.009 | T1565.001 | T1565.002 | T1566 | T1566.001 | T1567 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1567.001 | T1567.002 | T1567.003 | T1567.004 | T1568.002 | T1569.001 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1570 | T1571 | T1572 | T1574.004 | T1574.006 | T1574.007 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1580 | T1609 | T1610 | T1611 | T1614.001 | T1620 |
| Technique | Technique | Technique | Technique | Technique | Technique |
| --- | --- | --- | --- | --- | --- |
| T1622 | | | | | |
